...
(function (mod) {
    ...
    CodeMirror.defineMode('sass', (config) => {
        ...
        const colorKeywords = cssMode.colorKeywords || {};
        const valueKeywords = cssMode.valueKeywords || {};
        const fontProperties = cssMode.fontProperties || {};
                ...
                if (stream.eatWhile(/[\w-]/)) {
                    if (stream.match(/ *: *[\w-\+\$#!\("']/, false)) {
                        ...
                        if (propertyKeywords.hasOwnProperty(prop)) {
                            ...
                            state.prevProp = word;
                            return 'property';
                        } if (fontProperties.hasOwnProperty(word)) {
                            return 'property';
                        }
                        return 'tag';
