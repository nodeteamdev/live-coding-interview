    ...
    CodeMirror.defineMode('markdown', (cmCfg, modeCfg) => {
      ...
      && state.indentation <= maxNonCodeIndentation && stream.match(hrRE);
         ...
         || state.prevLine.header || prevLineLineIsEmpty)) {
                ...
                return null;
            } if (firstTokenOnLine && state.indentation <= maxNonCodeIndentation && (match = stream.match(atxHeaderRE)) && match[1].length <= 6) {
                state.quote = 0;
            ...
            } if (state.indentation <= maxNonCodeIndentation && stream.eat('>')) {
                ...
                return getType(state);
            } if (firstTokenOnLine && state.indentation <= maxNonCodeIndentation && (match = stream.match(fencedCodeRE, true))) {
                state.quote = 0;
